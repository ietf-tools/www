...
from .. import AWS_S3_CUSTOM_DOMAIN, AWS_STORAGE_BUCKET_NAME, ALLOWED_HOSTS
...
# #S3 settings
DEFAULT_FILE_STORAGE = "ietf.s3utils.MediaRootS3BotoStorage"
THUMBNAIL_DEFAULT_STORAGE = DEFAULT_FILE_STORAGE
STATICFILES_STORAGE = "ietf.s3utils.StaticRootS3BotoStorage"
