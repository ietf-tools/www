...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('events', '0027_event_venue_section_title_not_required'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='eventpage',
            name='room_rates',
            field=wagtail.core.fields.StreamField((('room_rate', wagtail.core.blocks.CharBlock(classname='full title')), ('table', wagtail.contrib.table_block.blocks.TableBlock(table_options={'renderer': 'html'}))), blank=True),
        ),
    ]
